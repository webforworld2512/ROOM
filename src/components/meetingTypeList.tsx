...
const MeetingTypeList = () => {
    ...
    const createMeeting = async () => {
        ...
        try {
            if (!values.dateTime) {
                toast({
                    title: "Plese select a date and a time",
                })
                return;
            }
    ...
    xl:grid-cols-4'>
            <HomeCard
                ...
                handleClick={() => setMeetingState('isInstantMeeting')} className={''} />
            <HomeCard
