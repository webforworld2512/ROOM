    ...
    <nav className='flex flex-between fixed z-50 w-full bg-room-cave border-b border-room-rim px-6 py-4 lg:px-10'>
      ...
      <div className='flex items-center gap-4'>
        <a
          ...
          className='flex items-center gap-2 rounded-full border border-room-rim bg-room-surface px-4 py-2 text-sm font-medium text-room-ash hover:text-room-bone hover:border-room-ash transition-all whitespace-nowrap max-sm:hidden'
